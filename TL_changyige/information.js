$(document).ready(function(){
    ...
    createCard = function(data){
        ...
        headingH3.innerHTML = menpai_dict[data['menpai']] + " | " + data['rank'] + "级 | " + sex_dict[data['sex']] + " | " + server_dict[data['server']];
        headingH3.style.fontSize = '18px';
        ...
        if (data['chonglou'] != 0){
            price.innerHTML += "<span class='badge pull-right' style='font-size:14px; background-color: #FF3030'>重楼</span>";
        }
        ...
        attribute .innerHTML = "属性：<img width=18px src='" + attribute_dict[data['max_attribute']] + "'> " + data['max_attack'];
        ...
        if (data['ride'] == '0'){
            ...
            for (var i=0;i<data['ride'].length;i++){
                ride.innerHTML += "<img width=18px src='image/坐骑/" + ride_dict[data['ride'][i]] + ".jpg'> ";
            }
        }
        ...
        if (data['clothes'] == '0'){
            ...
            for(var i=0;i<data['clothes'].length;i++){
                clothes.innerHTML += "<img width=18px src='image/时装/" + clothes_dict[data['clothes'][i]] + ".jpg'> ";;
            }
        }
    ...
    // serverDict = {};
    // serverList = [];
    // serverNum =SERVER_INFO.length;
    // for(var k=0;k<serverNum;k++){
    //     temp = Object.keys(SERVER_INFO[k].server).length;
        
    //     for(var m=0;m<temp;m++){
    //         var id = SERVER_INFO[k].server[m].id;
    //         if (serverList.indexOf(id) == -1){
    //             serverList.push(id);
    //             serverDict[id] = [SERVER_INFO[k].server[m].name];
    //         }
    //         else{
    //             serverDict[id].push(SERVER_INFO[k].server[m].name);
    //         }
    //     }
    // }
    // server_dict = {
